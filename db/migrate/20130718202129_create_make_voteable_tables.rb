class CreateMakeVoteableTables < ActiveRecord::Migration
   def self.up
    ...
    add_column :students, :up_votes, :integer, :null => false, :default => 0
    add_column :students, :down_votes, :integer, :null => false, :default => 0
    add_column :invitations, :up_votes, :integer, :null => false, :default => 0
    add_column :invitations, :down_votes, :integer, :null => false, :default => 0
